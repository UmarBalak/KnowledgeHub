    ...
    def query(self, 
        ...
        try:
            ...
            prompt = (
                ...
                "   - Reply exactly with a single line: \"I don't know.\"\n"
                ...
                "Output format (strict, use Markdown headings in this order):\n"
                "  ## Answer\n"
                "  - Short summary or steps. Keep it concise.\n\n"
                "  ## Evidence / Snippets\n"
                "  - List the exact retrieved snippet(s) used. Prefix each with 'Snippet used:' and do not invent source identifiers.\n"
                "  - If no snippet metadata is available, mark 'Source: provided separately' or 'Source: unavailable' as appropriate. Do not ask the user for citation metadata unless explicitly asked.\n\n"
                "  ## Limitations\n"
                "  - Single-line summary of what is unknown or unsupported by the provided context.\n\n"
                "  ## Assumptions\n"
                "  - Bullet any assumptions made when producing the answer.\n\n"
                "  ## Suggested next steps\n"
                "  - 1-3 concrete actions (e.g., upload file X, clarify Y, request deeper dive).\n\n"
                "  ## Follow-up questions\n"
                "  Q1: ...\n"
                "  Q2: ...\n"
                "  Q3: ...\n\n"
